...
public class SurveyBean implements Serializable {
    ...
    try {
        ...
        //Be sure to change the following lines to chnage database
        conn = DriverManager.getConnection(
                "jdbc:mysql://localhost:3307/surveydb",
                "TheOne",
                "5071");
        //End of line changes that should be made herea
    ...
    public boolean saveSurvey(){
        String sql="INSERT INTO survey_data("+
                    "name, email,phone,age,gender,qualification,"+
